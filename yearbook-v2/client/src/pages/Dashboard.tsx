    ...
    return (
      <div className="app">
        ...
        <main className="main" style={{ justifyContent: 'center', alignItems: 'center' }}>
          <div className="content-page" style={{ maxWidth: '400px', width: '100%', background: 'rgba(0,20,50,0.7)', border: '1px solid rgba(0,229,204,0.2)', borderRadius: '16px', backdropFilter: 'blur(12px)', boxShadow: '0 8px 32px rgba(0,0,0,0.4)', padding: '32px 28px' }}>
        ...
        <footer style={{ textAlign: 'center', padding: '12px 16px', fontSize: '0.72rem', color: 'rgba(160,200,232,0.5)', borderTop: '1px solid rgba(0,229,204,0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '16px', flexWrap: 'wrap' }}>
          ...
          <a href="mailto:bozgun76@gmail.com" style={{ color: 'rgba(0,229,204,0.6)', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '4px' }}>
